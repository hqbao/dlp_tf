...
anno_file_path = '../datasets/wider_face/full_train_anno.txt'
img_dir_path = '../datasets/wider_face/full_train_images'
test_anno_file_path = '../datasets/wider_face/full_test_anno.txt'
test_img_dir_path = '../datasets/wider_face/full_test_images'
output_path = 'output'
ishape = [448, 448, 1]
total_epoches = 1000
total_examples = 12000 # 12678
total_test_examples = 3000 # 3164
batch_size = 100 # 100
