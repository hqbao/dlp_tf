...
import numpy as np
from models import build_sml_test_model
...
abox_2dtensor = tf.concat(values=[a1box_2dtensor, a2box_2dtensor, a3box_2dtensor], axis=0)

model = build_sml_test_model(
	ishape=ishape, 
...
open('{}/det_sml_model.tflite'.format(output_path), 'wb').write(tflite_model)
