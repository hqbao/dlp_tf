...
def loss(total_classes, lamda=1.0):
	...
	def ssd_loss(y_true, y_pred):
		...
		Arguments
			y_true: (h1*w1*k1 + h2*w2*k2 + h3*w3*k3 + h4*w4*k4, total_classes+1+4)
			y_pred: (h1*w1*k1 + h2*w2*k2 + h3*w3*k3 + h4*w4*k4, total_classes+1+4)
		Return
			loss
		'''

		true_clz_2dtensor = y_true[:, :total_classes+1] # (h1*w1*k1 + h2*w2*k2 + h3*w3*k3 + h4*w4*k4, total_classes+1)
		pred_clz_2dtensor = y_pred[:, :total_classes+1] # (h1*w1*k1 + h2*w2*k2 + h3*w3*k3 + h4*w4*k4, total_classes+1)
		true_loc_2dtensor = y_true[:, total_classes+1:] # (h1*w1*k1 + h2*w2*k2 + h3*w3*k3 + h4*w4*k4, 4)
		pred_loc_2dtensor = y_pred[:, total_classes+1:] # (h1*w1*k1 + h2*w2*k2 + h3*w3*k3 + h4*w4*k4, 4)

		sum_true_clz_2dtensor = tf.math.reduce_sum(input_tensor=true_clz_2dtensor, axis=-1) # (h1*w1*k1 + h2*w2*k2 + h3*w3*k3 + h4*w4*k4,)
		...
		loc_loss = tf.math.reduce_sum(input_tensor=smooth_l1(true_loc_2dtensor, pred_loc_2dtensor), axis=-1) # (f,), f must be one at least
